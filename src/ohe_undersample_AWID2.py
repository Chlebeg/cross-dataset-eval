...
ROOT = "/root/learning"
AWID_DIR = ROOT + "/AWID2"
AWID_SCALED = AWID_DIR + "/AWID2_scaled"
AWID_READY = AWID_DIR + "/AWID2_ready"
AWID_DOWNSAMPLED = AWID_DIR + "/AWID2_downsampled"


def oneHotEncodeAWID2(df):
    ### Perform OneHotEncoding
    df = pd.get_dummies(df, columns=FEATURES_ONE_HOT_ENCODING, drop_first=True)
    ### Add missing columns after OHE
    df['wlan.fc.subtype_15'] = False
    df['radiotap.present.tsft_1'] = True
    df['radiotap.channel.flags.cck_1'] = False
